...
**Table 7:** Harmonized `r params$trait.name` and LOAD datasets
...
**Table 8:** Harmonized `r params$trait.name` and AAOS datasets
...
**Table 9:** Harmonized `r params$trait.name` and AB42 datasets
...
**Table 10:** Harmonized `r params$trait.name` and Ptau datasets
...
**Table 11:** Harmonized `r params$trait.name` and Tau datasets
...
rm(igap.dat, aaos.dat, ab42.dat, ptau.dat, tau.dat)
```
