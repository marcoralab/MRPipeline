...
params:
  ...
  ptau.summary: 
  tau.summary: 
  hipv.summary: ~/Dropbox/Research/PostDoc-MSSM/2_MR/2_DerivedData/hipv_GWAS.Processed.gz
  trait.summary: ~/Dropbox/Research/PostDoc-MSSM/2_MR/2_DerivedData/alcc_GWAS.Processed.gz
  trait.clump: None
  trait.name: Alc
  trait.blurb: Alc
  trait.code: alcc
