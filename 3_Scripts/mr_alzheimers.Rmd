...
#Mendelian Randomization Analysis: `r params$trait.name` and Alzheimer\'s Disease
...
```{r DatasetCreation, child = 'MR_dataset_creation.Rmd'}
```

```{r MRanalysis, child = 'MR_analysis.Rmd'}
```
