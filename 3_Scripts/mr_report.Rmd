...
```{r scatter_plot_outlier, eval = plot_outlier, echo=F, message = FALSE, warning=F, fig.width=7.5, fig.height=4.7, fig.align='center', fig.cap= 'Fig. 3: Scatterplot of SNP effects for the association of the Exposure on the Outcome after outlier removal'}
