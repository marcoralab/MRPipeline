...
heterogenity_plei %>% mutate(date = Sys.Date()) %>% write_csv(paste0(params$out, '_MRPRESSO_heterogenity.csv'))
mr_plei %>% mutate(date = Sys.Date()) %>% write_csv(paste0(params$out, '_MR_egger_plei.csv'))
mrpresso_plei %>% mutate(date = Sys.Date()) %>% write_csv(paste0(params$out, '_MRPRESSO_egger_plei.csv'))
