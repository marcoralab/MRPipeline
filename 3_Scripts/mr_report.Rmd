...
write_csv(heterogenity, paste0(params$out, '_MR_heterogenity.csv'))
write_csv(mr_plei, paste0(params$out, '_MR_egger_plei.csv'))
write_csv(res, paste0(params$out, '_MR_Results.csv'))
write_csv(res_mrpresso, paste0(params$out, '_MRPRESSO_Results.csv'))
```
