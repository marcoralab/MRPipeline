...
nsnps <- max(nrow(trait_LOAD.MRdat), nrow(trait_AAOS.MRdat), nrow(trait_AB42.MRdat), nrow(trait_Ptau.MRdat), nrow(trait_Tau.MRdat))
...
```{r heterogeneity traitumption_AB42, echo=F}
...
```{r heterogeneity traitumption_Ptau, echo=F}
...
```{r heterogeneity traitumption_Tau, echo=F}
